# This file contains the values of the E-Series used for electronic part values (RLC)
#
...
def valMat(Series, expoMin, expoMax):
    eSeries_Mat = []
    for x in range(expoMin, expoMax+1):
        eSeries_Mat.append([val*Decimal(str(10**x)) for val in eSeriesValues[Series]])
        #eSeries_Mat.append([val.scaleb(x) for val in E3]) # Returns scientific notation aka elements like "Decimal('2.2E+2')"
    return eSeries_Mat